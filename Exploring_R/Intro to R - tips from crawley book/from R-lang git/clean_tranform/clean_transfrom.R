...
rm(list = c("deer_endocranial_volume", "deer_long", "deer_wide", "deer_wide_again", "english_monarchs", "measurements_by_deer", "individual_rulers", "gender", "year_order", "th", "multiple_kingdoms", "multiple_rulers")
 rm
